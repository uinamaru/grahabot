<div class="title">
<span class="title">猫窝>>球球>>管理系统</span><br>
<div class="dropdown">
...
### 猫猫开关 <span class="hints">移到指令框上可以看到“复制”按钮哦~</span>
* 指令（不艾特+必须和猫猫在同一个群）
```
关闭水晶公
```
...
例：关闭水晶公
* 说明
>[warning]让球球使用管理权限关闭当前群聊中的猫猫机器人。

### 球球开关 <span class="hints">移到指令框上可以看到“复制”按钮哦~</span>
* 指令（不艾特）
```
...
例：
* 说明
>[warning]将群里的亚拉戈球球关闭或减少其活跃度。

### 猫窝群管
* 说明
>[warning]群管功能。现在仅在猫猫领养群内有效，负责猫窝的入退群监控和新人引导。
