<div class="title">
<span class="title">猫窝>>猫猫>>隐藏指令</span><br>
<div class="dropdown">
...
### 介绍
>[warning]含有非全龄内容的特殊指令。请不要在大群里使用。
### 考哥jpg <span class="hints">移到指令框上可以看到“复制”按钮哦~</span>
* 查看音轨表（艾特）
```
音轨介绍
```
...
* 说明
>[warning]声优梗，开火箭警告。
### 猫球互动 <span class="hints">移到指令框上可以看到“复制”按钮哦~</span>
* 指令（艾特+猫猫和球球必须在同一个群里）
```
打球球
```
